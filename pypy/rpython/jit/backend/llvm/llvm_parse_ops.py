...
class LLVMOpDispatcher:
    ...
    def parse_new_array(self, op):
        ...
        arg_types = [lltype.Signed, llmemory.GCREF]
        ret_type = llmemory.GCREF
        func_int_ptr = self.get_func_ptr(self.cpu.bh_new_array, arg_types,
                                         ret_type)
        ...
        if array_descr.is_array_of_structs():
            # can't represent structs though
