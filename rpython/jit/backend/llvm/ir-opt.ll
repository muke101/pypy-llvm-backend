...
resume_block:                                     ; preds = %call_block, %entry
  ...
  %struct_elem_ptr3 = getelementptr { i8*, i64, i8*, i8*, i8*, i8*, i8*, [3 x i64] }, { i8*, i64, i8*, i8*, i8*, i8*, i8*, [3 x i64] }* %0, i64 0, i32 1
  store i64 139773544440048, i64* %struct_elem_ptr3, align 8
  store i64 %cond_phi, i64* %struct_elem_ptr, align 8
